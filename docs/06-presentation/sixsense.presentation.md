...
footer: 'KAIST CAIO 10기 6조 · v2.4.1 · 2026-09-25'
style: |
  section {
...
<span class="small">KAIST CAIO 10기 6조 · v2.4.1 (2026-09-25 — 예측 검증 + 화면 정직화 + 수집기 복구 + 재현성 + 불합격 예측의 참고 표시)</span>
...
**Git history**: 122 commits · 문서: [prd.md](../../prd.md) · [plan](../01-plan/features/sixsense.plan.md) · [design](../02-design/features/sixsense.design.md) · [CHANGELOG](../../CHANGELOG.md)
...
|---|---|---|---|
| 평균 오차 (MAPE) | <span class="neg">34.3%</span> | 20.5% | <span class="pos">15.7%</span> |
| 기준선을 이긴 비율 | 14.7% | 53.7% (p = 0.146, 우연과 구분 안 됨) | — |
| 오르내림 적중률 | 32.0% | 69.7% | "항상 오른다" 찍기 70.6% |
