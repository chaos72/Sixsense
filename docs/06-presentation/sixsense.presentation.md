...
| 🔍 **예측 검증** | AI 모델 오차 <span class="neg">34.0%</span> vs 단순 기준선(지난주 값 유지) <span class="pos">15.7%</span> → **불합격** — 예측값은 "❌ 불합격 · 참고용" 표시와 불합격 이유 설명을 붙여 표시 |
...
|---|---|---|---|
| 평균 오차 (MAPE) | <span class="neg">34.0%</span> | 21.8% | <span class="pos">15.7%</span> |
| 기준선을 이긴 비율 | 16.0% | 54.5% (p = 0.736, 우연과 구분 안 됨) | — |
...
| 예측 검증 | **불합격** — 모델 34.0% vs 단순 기준선 15.7% (231회 워크포워드) |
