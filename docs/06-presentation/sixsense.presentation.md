...
footer: 'KAIST CAIO 10기 6조 · v2.3.2 · 2026-09-25'
style: |
  section {
...
<span class="small">KAIST CAIO 10기 6조 · v2.3.2 (2026-09-25 — 예측 검증 도입 + 화면 정직화 + 수집기 복구 + 재현성 확보)</span>
...
| 🔍 **예측 검증** | AI 모델 오차 <span class="neg">32.9%</span> vs 단순 기준선(지난주 값 유지) <span class="pos">15.7%</span> → **불합격, 예측 미표시** |
...
**Git history**: 114 commits · 문서: [prd.md](../../prd.md) · [plan](../01-plan/features/sixsense.plan.md) · [design](../02-design/features/sixsense.design.md) · [CHANGELOG](../../CHANGELOG.md)
